...
const longFormDid = `did:atom:${uniqueSuffix}:`;
...
describe('CRUD', () => {
  describe('create', () => {
    ...
    it('can resolve long form did', async () => {
      const operation1 = await atom.handleResolveRequest(longFormDid);
    ...
    it('can register and resolve short form did', async () => {
      const operation0 = await atom.handleOperationRequest(
